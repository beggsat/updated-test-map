...
var stats = new ol.layer.Group({
    title: 'Stats',
    layers: [lyr_Frequency_1,lyr_FrequencyBand_2,lyr_CellEdgeMedian_3,lyr_ULMbpsLabels_4,lyr_TestsbyULMbps_5,lyr_DLMbpsLabels_6,lyr_TestsbyDLMbps_7,lyr_RSRPLabels_8,lyr_TestsbyRSRP_9]
});

var baselayers = new ol.layer.Group({
    title: 'Baselayers',
    layers: [lyr_OpenStreetMap_0, lyr_tower_10]
});

var cells = new ol.layer.Group({
    title: 'Cells',
    layers: [lyr_gridcells_ashburn_11,lyr_testing_groups_12],
    opacity: 0.5
});
...
var map = new ol.Map({
    ...
    layers: [baselayers, cells, stats],
    view: new ol.View({
        extent: [-8626722.071256, 4722995.641288, -8617948.335957, 4728920.173887], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([-8626722.071256, 4722995.641288, -8617948.335957, 4728920.173887], map.getSize());
